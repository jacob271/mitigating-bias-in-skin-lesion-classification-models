          ...
          <section className="mb-8">
            <h1 className="text-5xl font-bold mb-2">Mitigating Bias in Skin Lesion Classification Models Using Variational Autoencoders</h1>
              <p className="text-lg text-gray-500">
                  This page provides a summary of my bachelor thesis which is available in the corresponding <a href="https://github.com/jacob271/mitigating-bias-in-skin-lesion-classification-models" className="text-black hover:text-blue-700"><FontAwesomeIcon icon={faCodeBranch} className="mr-1" />repository</a>. If you want to learn more about me, check out my <a href="https://jacobschaefer.de" className="text-black hover:text-blue-700"><FontAwesomeIcon icon={faGlobe} className="mr-1" />Website</a>, take a look at some other projects of mine on my <a href="https://github.com/jacob271" className="text-black hover:text-blue-700"><FontAwesomeIcon icon={faCodeBranch} className="mr-1" />GitHub Profile</a>, or connect with me on <a href="https://www.linkedin.com/in/jsjacobschaefer/" className="text-black hover:text-blue-700"><FontAwesomeIcon icon={faLinkedin} className="mr-1" />LinkedIn</a>.
              </p>
          </section>
