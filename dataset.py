...
test_transform = transforms.Compose([transforms.CenterCrop((450, 450)), transforms.Normalize(DATA_MEANS, DATA_STD)])

train_transform = transforms.Compose([transforms.CenterCrop((450, 450)), transforms.RandomHorizontalFlip(),
                                      transforms.RandomResizedCrop((450, 450), scale=(0.8, 1.0), ratio=(0.75, 1.33),
                                                                   antialias=True),
